<?php
    ...
    $query = mysqli_query ($kon,"select * from produk a inner join kategori k on k.id_kategori=a.id_kategori where id_produk='".$id_produk."' limit 1");
        ...
        <div class="thumbnail">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $data["judul_produk"];?></li>
                </ol>
            </nav>
            <img src="admin/produk/gambar/<?php echo $data['gambar'];?>" width="100%" alt="Cinque Terre">
            <div class="caption">
                <?php
                echo strip_tags(html_entity_decode($data["isi_produk"],ENT_QUOTES,"ISO-8859-1"));
                 ?>
                <hr>
            </div>
            <?php
            ...
            <div class="row">
                <?php
                    include 'config/database.php';
                    $sql="select * from komentar where id_produk=$id_produk and status_komentar=1 order by id_komentar desc";
