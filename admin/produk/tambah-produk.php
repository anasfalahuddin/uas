        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($gambar)){
                if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                    ...
                    $sql="insert into produk (kode_produk,judul_produk,isi_produk,gambar,tanggal,status,id_kategori) values
                    ('$kode_produk','$judul_produk','$isi_produk','$gambar','$tanggal','$status','$kategori')";
                }    
                
            }else {
                    //Menambah produk tanpa gambar, maka gambar_defauilt.png yang akan digunakan
                    $sql="insert into produk (kode_produk,judul_produk,isi_produk,tanggal,status,id_kategori) values
                    ('$kode_produk','$judul_produk','$isi_produk','$tanggal','$status','$kategori')";
...
<form action="produk/tambah-produk.php" method="post" enctype="multipart/form-data">
    ...
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <textarea name="isi_produk" class="form-control"  rows="5" ></textarea>
        </div>
    </div>
    </div>
    <!-- rows -->
